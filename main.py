...
p1wins = font.render('Player 1 wins!', True, (0, 0, 255))
p1wins_rect = p1wins.get_rect().width
p2wins = font.render('Player 2 wins!', True, (0, 0, 255))
p2wins_rect = p2wins.get_rect().width

font2 = pygame.font.SysFont('pixel', 50)
numChoose = font.render('Choose the number of players: (1/2)', True, (0, 0, 255))
